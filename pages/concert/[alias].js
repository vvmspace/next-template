...
const Event = props => {
    ...
    return (
        <Layout overlay={
            <a style={{position: 'fixed', bottom: 0, left: 0, right:0, display: 'block', width: '100%', textAlign: 'center', textTransform: 'uppercase', }} href={'#'} onClick={goPnm(event)}>Купить билеты</a>
        }>
            <Head>
